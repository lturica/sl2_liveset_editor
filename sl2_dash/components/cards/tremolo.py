...
tremolo_c1_tts, tremolo_c1_card, tremolo_c1_outputs, tremolo_c1_state = (
    create_tremolo_channel_card(1)
)
tremolo_c2_tts, tremolo_c2_card, tremolo_c2_outputs, tremolo_c2_state = (
    create_tremolo_channel_card(2)
)
