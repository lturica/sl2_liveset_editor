...
phaser_c1_tts, phaser_c1_card, phaser_c1_outputs, phaser_c1_state = (
    create_phaser_channel_card(1)
)
phaser_c2_tts, phaser_c2_card, phaser_c2_outputs, phaser_c2_state = (
    create_phaser_channel_card(2)
)
