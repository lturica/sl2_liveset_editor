                        ...
                        dbc.Col(
                            [
                                dbc.Label(
                                    [
                                        "Ch. 2 Bypass",
                                        make_tooltip(mixer_tts["Ch. 2 Bypass"]),
                                    ]
                                ),
                                dbc.Switch(
                                    id=mixer_params["Ch. 2 Bypass"], value=0, label=None
                                ),
                            ],
                            width="auto",
                        ),
                        dbc.Col(
                            [
                                dbc.Label(
                                    [
                                        "Direct Signal",
                                        make_tooltip(mixer_tts["Param 1"]),
                                    ]
                                ),
                        ...
                        dbc.Col(
                            [
                                dbc.Label(
                                    [
                                        "Direct Volume",
                                        make_tooltip(mixer_tts["Param 2"]),
                                    ]
                                ),
                                dcc.Slider(
                                    id=mixer_params["Param 2"],
                                    min=0,
                                    max=127,
                                    value=100,
                                    **SLIDER_ARGS,
                        ...
                        dbc.Col(
                            [
                                dbc.Label(
                                    [
                                        "Sliced Signal",
                                        make_tooltip(mixer_tts["Param 3"]),
                                    ]
                                ),
                        ...
                        dbc.Col(
                            [
                                dbc.Label(
                                    [
                                        "Sliced Volume",
                                        make_tooltip(mixer_tts["Param 4"]),
                                    ]
                                ),
                                dcc.Slider(
                                    id=mixer_params["Param 4"],
                                    min=0,
                                    max=100,
                                    value=100,
                                    **SLIDER_ARGS,
...
mixer_outputs = [
    Output(mx, "value", allow_duplicate=True) for mx in mixer_params.values()
]
