        ...
        dbc.NavItem(
            dbc.NavLink(
                dbc.Row(
                    [
                        dbc.Col(
                            html.I(className="bi bi-question-circle fs-4"),
                            width="auto",
            ...
            dcc.Upload(
                dbc.NavLink(
                    dbc.Row(
                        [
                            dbc.Col(
                                html.I(className="bi bi-upload fs-4"),
                                width="auto",
                                style={"marginRight": "0.5rem"},
                            ),
        ...
        dbc.NavItem(
            dbc.NavLink(
                dbc.Row(
                    [
                        dbc.Col(
                            html.I(className="bi bi-folder2-open fs-4"),
                            width="auto",
                            style={"marginRight": "0.5rem"},
                        ),
                        dbc.Col(
                            html.H5("Load Default .tsl", style={"marginTop": "9px"})
                        ),
                    ],
                    align="center",
                    className="g-0",
        ...
        dbc.NavItem(
            dbc.NavLink(
                dbc.Row(
                    [
                        dbc.Col(
                            html.I(className="bi bi-download fs-4"),
                            width="auto",
                            style={"marginRight": "0.5rem"},
                        ),
        ...
        dbc.NavItem(
            dbc.NavLink(
                dbc.Row(
                    [
                        dbc.Col(
                            html.I(className="bi bi-info-circle fs-4"),
                            width="auto",
                            style={"marginRight": "0.5rem"},
                        ),
