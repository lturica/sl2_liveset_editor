...
def register_text_check_callbacks(app: dash.Dash) -> None:
    ...
    @app.callback(
        [
            Output(GlobalSettings.LIVE_SET_NAME, "valid"),
            Output(GlobalSettings.LIVE_SET_NAME, "invalid"),
        ],
    ...
    @app.callback(
        [
            Output(GlobalSettings.PATCH_NAME, "valid"),
            Output(GlobalSettings.PATCH_NAME, "invalid"),
        ],
