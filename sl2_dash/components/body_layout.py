...
parameter_cards = dbc.Tabs(
    [
        dbc.Tab(
            ...
            label="Slicer",
            tab_id="slicer_c12_tab",
        ),
        dbc.Tab(
            [phaser_c1_card, phaser_c2_card], label="Phaser", tab_id="phaser_c12_tab"
        ),
        dbc.Tab(
            [flanger_c1_card, flanger_c2_card],
            label="Flanger ",
            tab_id="flanger_c12_tab",
        ),
        dbc.Tab(
            [tremolo_c1_card, tremolo_c2_card],
            label="Tremolo",
            tab_id="tremolo_c12_tab",
        ),
        dbc.Tab(
            [overtone_c1_card, overtone_c2_card],
            label="Overtone",
            tab_id="overtone_c12_tab",
        ),
