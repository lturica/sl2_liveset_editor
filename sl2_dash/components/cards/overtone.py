...
def create_overtone_channel_card(cnum: int):
    ...
    card = dbc.Card(
        [
            dbc.CardHeader(
                f"Overtone Channel {cnum} Parameters",
            ),
            dbc.CardBody(
                [
                    dbc.Row(
                        [
                            ...
                            dbc.Col(
                                [
                                    dbc.Label(
                                        ["Detune", make_tooltip(tt_names["Param 5"])]
                                    ),
                                    dcc.Slider(
                                        id=p_names["Param 5"],
                                        min=0,
                            ...
                            dbc.Col(
                                [
                                    dbc.Label(
                                        ["Low", make_tooltip(tt_names["Param 6"])]
                                    ),
                                    dcc.Slider(
                                        id=p_names["Param 6"],
                                        min=0,
                            ...
                            dbc.Col(
                                [
                                    dbc.Label(
                                        ["High", make_tooltip(tt_names["Param 7"])]
                                    ),
                                    dcc.Slider(
                                        id=p_names["Param 7"],
                                        min=0,
...
overtone_c1_tts, overtone_c1_card, overtone_c1_outputs, overtone_c1_state = (
    create_overtone_channel_card(1)
)
overtone_c2_tts, overtone_c2_card, overtone_c2_outputs, overtone_c2_state = (
    create_overtone_channel_card(2)
)
