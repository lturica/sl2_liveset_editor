    ...
    dbc.Modal(
        [
            ...
            dbc.ModalFooter(
                [
                    dbc.Button(
                        "Load", id=Nav.LOAD_DEFAULT_BUTTON, color="primary", n_clicks=0
                    ),
                ]
            ),
        ],
        ...
        [
            ...
            dbc.ModalBody(
                [
                    ...
                    dbc.Label(
                        "Note: You cannot delete the last remaining patch in the live set."
                    ),
                    html.Div(style={"marginTop": "0.5rem", "fontSize": "0.9rem"}),
                ]
            ),
            dbc.ModalFooter(
                [
                    dbc.Button(
                        "Delete",
                        id=GlobalSettings.CONFIRM_DELETE_BUTTON,
                        color="danger",
                        n_clicks=0,
                    ),
                ]
    ...
    dbc.Modal(
        [
            ...
            dbc.ModalBody(
                [
                    html.P(
                        "This tool is used to create and edit the .tsl patch files used through BOSS Tone Studio for the "
                        " SL-2 Slicer effect pedal."
                    ),
                    html.P(
                        "The navigation bar at the top allows you to upload your own live set, select a pre-built one, or download the current live set."
                    ),
                    html.P(
                        "The left column allows you to rename the live set and current patch. You can also change the current patch, duplicate it, or delete it. "
                    ...
                    html.P(
                        "The patch parameters can be edited in the main tabs in the centre of the UI. You can click on the help tooltips next to each parameter to view the information we currently "
                        "have about it (if any)."
                    ),
                    html.P(
                        "More information about the app, correctness of the labels, developers, license, and "
                        "more can be found in the About section in the navigation bar."
                    ),
                    html.P(
                        "You can always open these instructions by clicking the instructions button at the top of this page."
                    ),
                ]
            ),
        ],
    ...
    dbc.Modal(
        [
            ...
            dbc.ModalBody(
                [
                    html.P(
                        "The SL-2 Live Set Editor tool is currently under development. Many parameters (most of the non-slicer-effect-parameters) "
                        "have untested or generic names and descriptions assigned to them."
                    ),
                    html.P(
                        "As we learn more about the functions of the unlabeled parameters, we will update the names, tooltip"
                        " descriptions, and permissible value ranges."
                    ),
                    html.P(
                        "If you encounter issues with the tool, have information about one of the parameters,"
                    ...
                    html.P(
                        [
                            "A lot of the information about the parameters originates from the "
                            "Parameter Guide for the BOSS GT-1000 Guitar Effects Processor, available ",
                            html.A(
                                "here",
                                href="https://www.boss.info/us/support/by_product/gt-1000/owners_manuals/",
                                target="_blank",
                            ),
                            " and ",
                            html.A(
                                "here",
                                href="https://www.zikinf.com/manuels/boss-gt-1000-parameter-guide-en-70162.pdf",
                                target="_blank",
                            ),
                            ". ",
                            ...
                            html.A(
                                "GitHub repo",
                                href="https://github.com/pylonsarenice/SL2-Pattern-Editor",
                                target="_blank",
                            ),
                            " or in this ",
                            html.A(
                                "Google Doc",
                                href="https://docs.google.com/document/d/1iCooADNApTqPilJJXJ9s6jXgYUmfDu4exT8Dbz0rzi8/edit?tab=t.0",
                                target="_blank",
                            ),
                            ".",
                        ]
                    ...
                    html.P(
                        [
                            "Immense thanks to Andrew Hill (u/BackgroundWasabi), who built the original version of this app. "
                            "The original version can be found at ",
                            html.A(
                                "https://sl2-patch-editor.xyz/",
                                href="https://sl2-patch-editor.xyz/",
                                target="_blank",
                            ),
                            " and in this ",
                            html.A(
                    ...
                    html.P(
                        [
                            "If you would like to support me, find me ",
            ...
            dbc.ModalFooter(
                html.P(
                    [
                        "This tool is licensed under the MIT license, and provided as-is without any warranty. This tool"
                        ...
                        html.A(
                            "here",
                            href="https://bosstonecentral.com/liveset/category/sl-2/",
                            target="_blank",
                        ),
                        ".",
                    ],
        ...
        [
            ...
            dbc.ModalBody(
                [
                    ...
                    html.B("Note:"),
                    html.P(
                        " Currently, importing a .tsl file into Tone Studio sets 'name' property to the filename of the .tsl "
    ...
    dbc.Modal(
        [
            ...
            dbc.ModalBody(
                [
                    html.P(
                        "Sets the name for the patch, as displayed in Tone Studio. "
                    ...
                    html.B("Note:"),
                    html.P(
                        " The PATCH%COM array (and, therefore, the Patch Name value) is limited to 16 characters."
                    ),
                ]
            ),
        ],
    ...
    dbc.Modal(
        [
            ...
            dbc.ModalBody(
                [
                    html.P(
                        "Choose a different patch to visualise. Click Edit Patch to display."
                    ),
                    html.B("Notes:"),
                    html.P(
                        "The name of the current patch is only updated when the a different patch is loaded."
        ...
        [
            ...
            dbc.ModalBody(
                [
                    ...
                    html.B("Note:"),
                    html.P(
                        "For now this value is only allowed to be '0001' until the scope of this value is confirmed."
                    ),
                ]
            ),
        ],
    ...
    dbc.Modal(
        [
            ...
            dbc.ModalBody(
                [
                    html.P(
                        "Sets the 'memo' field in the .tsl file for the current patch."
                    ),
                    html.B("Note:"),
                    html.P(
                        "This is locked until the limitations of the Memo field are found through testing."
                    ),
                ]
            ),
        ],
        ...
        [
            ...
            dbc.ModalBody(
                [
                    ...
                    html.P(
                        "This can be a number of preset values, or 'USER' to enable a custom slicer patch."
                    ),
                    html.P(
                        "The preset sounds are related to the original SL-20 patches."
                    ),
                    html.B("Note:"),
                    html.P(
                        "Any value other than 'USER' will disable all sliders, since the preset pattern will override any"
        ...
        [
            ...
            dbc.ModalBody(
                [
                    ...
                    html.B("Note:"),
                    html.P(
                        "Disabling the channel will also disable the sliders for all parameter arrays in the channel."
                    ),
                ]
            ),
        ],
        ...
        [
            ...
            dbc.ModalBody(
                [
                    ...
                    html.P(
                        "If the value is set to 'PITCH', per-step pitch control is available in the Pitch Shift parameter"
                        " array."
                    ),
                    html.P(
                        "(If the value is anything other than 'PITCH', the Pitch Shift sliders are disabled since they have no "
    ...
    dbc.Modal(
        [
            ...
            dbc.ModalBody(
                [
                    html.P(
                        "Divides each measure into this number equal steps, where each step can be modified using the"
                        " Parameter Array sliders. "
                    ),
                    html.B("Note:"),
                    html.P(
                        "Choosing a value < STEP_24 will disable some sliders to indicate that these values will be ignored."
                    ),
                ]
            ),
        ],
    ...
    dbc.Modal(
        [
            ...
            dbc.ModalBody(
                [
                    html.P(
                        "The number of available time time steps is set by the Step Number dropdown list."
                    ),
                    html.H5(html.B("Step Length")),
                    html.P("Sets the length for each step in the pattern."),
                    html.P(
                        "Values are [0-100] and represent the length of time audio is heard for this step (i.e. value=50 means"
                        " that sound will be heard for 50% of the length of this step."
                    ),
                    html.P(
                        "A value of 0 mutes sound completely, and a value of 100 means audio plays uninterrupted for"
                        " this step."
                    ),
                    html.H5(html.B("Step Level")),
                    html.P(
                        "Values are [0-100] and represent relative volume/level of this step."
                    ),
                    html.H5(html.B("Band Pass")),
                    html.P("Sets a preset band pass filter value on each step."),
                    html.P(
                        "Values are [0-6]. A value of 0 disables the filter, and values 1-6 apply a band pass filter."
                    ),
                    html.H5(html.B("Effect Level")),
                    html.P(
                        "Sets the level of the effect sound specified by 'Effect Type' for this step."
                    ),
                    html.P(
                        "Values are [0-100] and represent relative level at each step."
                    ),
                    html.H5(html.B("Pitch Shift")),
                    html.P("Sets the amount of pitch shifting applied to this step."),
                    html.P(
                        "Values are [0,24] where 0 is one octave below, and 24 is one octave above. Default is 12 (no shift)."
                    ),
                    html.B("Note:"),
                    html.P(
                        "Choosing a value other than 'PITCH' for Effect Type will disable these sliders, since they have"
        ...
        dbc.Modal(
            [
                ...
                dbc.ModalBody(
                    [
                        html.P(
                            "Description from GT-1000 Manual. To be verified. There are too many parameters here to assign to sliders, but some are obviously not appropriate for the SL-2."
                        ),
                        html.B("TYPE"),
                        html.P("Selects the PHASER type."),
                        html.P(
                            "PRIME: An original BOSS phaser providing modulation not obtainable from previous units."
                        ),
                        html.P(
                            "SCRIPT: Models the MXR Phase 90 manufactured in the ’70s."
                        ),
                        html.B("STAGE"),
                        html.P(
                            "Selects the number of stages used in the phaser effect: 2, 4, 8, 16, or 24."
                        ),
                        html.B("RATE"),
                        html.P("Sets the rate of the phaser effect."),
                        html.P(
                            "When set to BPM, parameters follow the MASTER BPM for each patch."
                        ),
                        html.P(
                            "If the BPM-based time exceeds the allowed range, it syncs to 1/2 or 1/4 of that period."
                        ),
                        html.B("DEPTH"),
                        html.P("Determines the depth of the phaser effect."),
                        html.B("RESONANCE"),
                        html.P(
                            "Sets the amount of resonance (feedback). Higher values emphasize the effect and create more unusual sounds."
                        ),
                        html.B("MANUAL"),
                        ...
                        html.B("STEP RATE"),
                        html.P(
                            "Sets the cycle of the step function that changes rate and depth."
                        ),
                        html.P("Higher values produce finer steps."),
                        html.P("Set to OFF to disable the step function."),
                        html.P(
                            "When set to BPM, the step rate follows MASTER BPM with the same timing rules as RATE."
                        ),
                        html.B("BI-PHASE"),
                        html.P(
                            "ON connects the two phase-shift circuits in series; OFF disables series routing."
                        ),
                        html.B("SEPARATION"),
                        html.P(
                            "Adjusts diffusion (0–180 degrees). Higher values increase diffusion."
                        ),
                        html.B("LOW DAMP"),
                        html.P(
                            "Adjusts feedback for the low-frequency region (-100 to 0)."
                        ),
                        html.B("HIGH DAMP"),
                        html.P(
                            "Adjusts feedback for the high-frequency region (-100 to 0)."
                        ),
                        html.B("LOW CUT"),
                        html.P(
                            "Sets the low-cut filter frequency (FLAT or 20 Hz–20 kHz). FLAT disables the filter."
                        ),
                        html.B("HIGH CUT"),
                        html.P(
                            "Sets the high-cut filter frequency (20 Hz–20 kHz or FLAT). FLAT disables the filter."
                        ),
                        html.B("DIRECT MIX"),
                        ...
                        html.P(
                            "BPM indicates the number of quarter-note beats per minute."
                        ),
                        html.P(
                            "When external MIDI is connected, MASTER BPM may sync to the MIDI device, preventing manual setting unless SYNC CLOCK is set to INTERNAL."
                        ),
                    ]
                ),
            ],
            centered=True,
            id=f"phaser_param_{i + 1}_tt_modal",
        )  # phaser_param_1_tt_modal
    )
...
for i in range(10):
    flanger_parameter_n_modal = register_modal(
        dbc.Modal(
            [
                ...
                dbc.ModalBody(
                    [
                        ...
                        html.P(
                            "When set to BPM, the parameter values follow the MASTER BPM setting for each patch."
                        ),
                        html.P(
                            "If the BPM-based time exceeds the range of the effect, it syncs to 1/2 or 1/4 cycle."
                        ),
                        html.B("DEPTH"),
                        html.P("Determines the depth of the flanging effect."),
                        html.B("RESONANCE"),
                        html.P(
                            "Sets the resonance (feedback). Higher values emphasize the effect and create more unusual sounds."
                        ),
                        html.B("MANUAL"),
                        html.P(
                            "Adjusts the center frequency at which the flanger is applied."
                        ),
                        html.B("TURBO"),
                        ...
                        html.B("STEP RATE"),
                        html.P(
                            "Sets the rate of the step function that varies the flanger in discrete steps."
                        ),
                        ...
                        html.B("SEPARATION"),
                        html.P(
                            "Adjusts diffusion (0–180 degrees). Higher values create more diffusion."
                        ),
                        html.B("EFFECT LEVEL"),
                        html.P("Adjusts the output level of the flanger effect."),
                        html.B("LOW DAMP"),
                        html.P(
                            "Adjusts the amount of feedback for low frequencies (-100 to 0)."
                        ),
                        html.B("HIGH DAMP"),
                        html.P(
                            "Adjusts the amount of feedback for high frequencies (-100 to 0)."
                        ),
                        html.B("LOW CUT"),
                        html.P(
                            "Sets the low-cut filter frequency (FLAT or 20 Hz–20 kHz). FLAT disables the low-cut filter."
                        ),
                        html.B("HIGH CUT"),
                        html.P(
                            "Sets the high-cut filter frequency (20 Hz–20 kHz or FLAT). FLAT disables the high-cut filter."
                        ),
                        html.B("DIRECT MIX"),
                        html.P("Adjusts the volume of the direct sound."),
                        html.B("BPM"),
            ...
            centered=True,
            id=f"flanger_param_{i + 1}_tt_modal",
        )  # flanger_param_1_tt_modal
    )
        ...
        dbc.Modal(
            [
                ...
                dbc.ModalBody(
                    [
                        html.P(
                            "Description from GT-1000 Manual. To be verified. There are too many parameters here, but it is likely that TRIGGER and BPM are non-existent in the SL-2."
                        ),
                        html.B("RATE"),
                        ...
                        html.B("RISE TIME "),
                        html.P(
                            "Specifies the time from when trigger turns on until the specified tremolo effect is obtained."
                        ),
                        html.B("DIRECT MIX "),
                        html.P("Adjusts the volume of the direct sound."),
                        html.B("BPM "),
                        ...
                        html.P(
                            "BPM (beats per minute) indicates the number of quarter note beats that occurmeach minute"
                        ),
                        html.P(
                            "When you have an external MIDI device connected, the MASTER BPM synchronizes to the external MIDI devices tempo, making it impossible to set the MASTER BPM. To enable setting of the MASTER BPM, set “SYNC CLOCK” (P.39) to “INTERNAL.”"
                        ),
                        html.P(
                            "The presets that have Tremolo enabled are: 'TREMOLO 5-**', 'SFX 7-08', 'McR Chord Fun', 'McR Dark Knight', 'McR Organ', 'TREMOLO WAVE', 'RISE UP'"
                        ),
                    ]
                ),
            ],
            centered=True,
            id=f"tremolo_param_{i + 1}_tt_modal",
        )  # tremolo_param_1_tt_modal
    )
    ...
    dbc.Modal(
        [
            ...
            dbc.ModalBody(
                [
                    html.P(
                        "Description from GT-1000 Manual. To be verified. Parameters might be mismatched."
                    ),
    ...
    dbc.Modal(
        [
            ...
            dbc.ModalBody(
                [
                    html.P(
                        "Param 1 is always 0 in the presets. The effect of changing this parameter is unknown."
                    ),
    ...
    dbc.Modal(
        [
            ...
            dbc.ModalBody(
                [
                    html.P(
                        "Param 2 is always 1 in the presets (with one exception in TREMOLO_WAVE preset). The effect of changing this parameter is unknown."
                    ),
                    # html.P("It is potentially related to ")
                ]
            ),
        ...
        [
            ...
            dbc.ModalBody(
                [
                    ...
                    html.P("Adjusts the volume of the direct sound."),
                    html.P(
                        "In the presets, this is 0 everywhere except for 'McR Ready 4 Beat', 'McR Techno 1', and 'McR Techno 2', where it is 30."
                    ),
                ]
            ),
        ],
    ...
    dbc.Modal(
        [
            ...
            dbc.ModalBody(
                [
                    html.P(
                        "Param 1 ranges between 0 and 3 in the presets. The effect of changing this parameter is unknown."
                    ),
                    html.P(
                        "It is potentially related to how the input signal is split and recombined."
                    ),
                ]
            ),
        ],
    ...
    dbc.Modal(
        [
            ...
            dbc.ModalBody(
                [
                    html.P(
                        "Param 2 is generally 9, but it ranges between 0 and 9 in the presets. The effect of changing this parameter is unknown."
                    ),
                    html.P(
                        "It is potentially related to how the input signal is split and recombined."
                    ),
    ...
    dbc.Modal(
        [
            ...
            dbc.ModalBody(
                [
                    html.P(
                        "If enabled, this switch seems to bypass Slicer Channel 2. If you want to run two slicer patterns"
                        " simultaneously, you will need to ensure that this switch is disabled."
                    ),
                    html.P(
                        "It is unknown whether this switch also bypass the effects (Phaser, Tremolo, etc) for Channel 2"
                        " as well."
                    ),
                ]
            ),
        ...
        dbc.Modal(
            [
                ...
                dbc.ModalBody(
                    [
                        html.P(
                            "Experimenting shows that the Mixer settings affect the direct signal (to which the effects are applied)"
                        ...
                        html.P(
                            "Description from GT-1000 manual. To be verified. In the manual, the Divider and Mixer parameters are related to each other."
                        ),
                        html.B("STEREO"),
                        html.P(
                        ...
                        html.B("PAN"),
                        html.P(
                            "L/R Channels “A” and “B” will be assigned respectively to the L and R OUTPUT jacks."
                        ),
                        html.B("A/B BALANCE "),
                        html.P(
                            "Adjusts the volume balance of channels “A” and “B.” This is shown only if DIVIDER MODE is set to “DUAL.”"
                        ),
                        html.B("SPREAD"),
                        html.P(
                            "Slightly delays the sound of channel “B” to make the sound more spacious. This is shown only if DIVIDER MODE is set to “DUAL.”"
                        ),
                    ]
                ),
            ],
            centered=True,
            id=f"mixer_param_{i + 1}_tt_modal",
        )  # mixer_param_1_tt_modal
    )
        ...
        [
            ...
            dbc.ModalBody(
                [
                    ...
                    html.P(
                        "0 represents -20dB; 20 represents +0dB; 40 represents +20dB."
                    ),
                ]
            ),
        ],
