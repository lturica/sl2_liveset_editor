...
stores = (
    dcc.Store(id=JSON_STORE, data=DEFAULT_STORE_DATA),  # main json storage location
    dcc.Store(id=CURRENT_PATCH_ID, data=0),  # number of the current patch
    dcc.Store(
        id=ChannelCopy.DOUBLE_CLICK_TIMESTAMP,  # date and time of the most recent click on the copy channel button
