...
err_toast = register_toast(
    dbc.Toast("Unable to parse .tsl file!",
                      id=Toast.LOAD_ERROR,
                      header="File Error",
                      is_open=False,
                      dismissable=True,
...
success_toast = register_toast(
    dbc.Toast("Loaded .tsl file sucessfully!",
...
patch_delete_fail_toast = register_toast(
    dbc.Toast("Unable to delete patch!",
